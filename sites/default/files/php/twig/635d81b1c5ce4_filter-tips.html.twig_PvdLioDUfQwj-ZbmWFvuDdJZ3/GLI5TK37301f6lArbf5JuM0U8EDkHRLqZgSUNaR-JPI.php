...
class __TwigTemplate_5f4078ca5f83626b6c83eb4f2ed3fb5e extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/d8w3css/templates/content-edit/filter-tips.html.twig", "/app/themes/contrib/d8w3css/templates/content-edit/filter-tips.html.twig");
    }
